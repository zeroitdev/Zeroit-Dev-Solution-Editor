...
namespace ZeroitDevSolutionEditor.Helpers.Animations
{
    ...
    public class ZeroitAnimator : Component, IExtenderProvider
    {
        ...
        {
            AnimationType = ZeroitDevSolutionEditor.Helpers.Animations.AnimationType.VertSlide;
        ...
        private void InitDefaultAnimation(ZeroitDevSolutionEditor.Helpers.Animations.AnimationType animationType)
        {
