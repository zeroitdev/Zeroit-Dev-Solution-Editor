...
namespace ZeroitDevSolutionEditor.Helpers
{
    ...
    public class MaterialComboBox : ComboBox
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (SelectedIndex >= 0) { 
            e.Graphics.DrawString(Items[SelectedIndex].ToString(), font.Roboto_Medium10, new SolidBrush(ForeColor), 0, 0);
            }
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            e.Graphics.DrawString(Items[e.Index].ToString(), font.Roboto_Medium10, new SolidBrush(ForeColor), new RectangleF(e.Bounds.X + rectangle.Width, e.Bounds.Y, e.Bounds.Width, e.Bounds.Height));
