namespace ZeroitDevSolutionEditor.Helpers.Editors
{
    partial class ComboColorPickerDialog
    {
        ...
        {
            this.comboColorPicker = new ZeroitDevSolutionEditor.Helpers.Editors.ComboColorPicker();
            this.SuspendLayout();
            // 
            // comboColorPicker
            // 
            ...
            this.comboColorPicker.ColorSelected += new ZeroitDevSolutionEditor.Helpers.Editors.BaseColorPicker.ColorSelectedEventHandler(this.comboColorPicker_ColorSelected);
            // 
