...
namespace ZeroitDevSolutionEditor.Helpers.Editors
{
    ...
    public partial class ColorGradientEditor : UserControl
    {
        ...
        {
            ZeroitDevSolutionEditor.Helpers.Editors.ComboColorPickerDialog d = new ZeroitDevSolutionEditor.Helpers.Editors.ComboColorPickerDialog(colorLabel.BackColor, colorButton);
