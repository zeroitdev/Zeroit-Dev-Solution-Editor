...
namespace ZeroitDevSolutionEditor.Helpers.Sliders
{
    /// <summary>
    ...
    public partial class ZeroitLollipopSlider : Control
    {
        /// <summary>
        /// Enum MouseState
        /// </summary>
        ...
        [Browsable(false)]
        public State MouseState { get; set; }
                ...
                case Orientation.Horizontal:
                    ...
                    if (e.Button == System.Windows.Forms.MouseButtons.Left && e.Y > IndicatorRectanglePressed.Top && e.Y < IndicatorRectanglePressed.Bottom)
                    {
                        ...
                        if (e.X >= IndicatorSize / 2 && e.X <= Width - IndicatorSize / 2)
                        {
                            ...
                            {
                                _Value = v;
                                if (ValueChanged != null) ValueChanged((int)_Value);
                            }
                            RecalcutlateIndicator();
                        }
                    }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            float percentage = (Value / (MaxValue - MinValue)) * MaxValue;
